package com.github.coss.common.core.helper;
...
public class PropertiesHelper {
    ...
    public URL getURL(String key) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Property " + key + " must be a valid URL ("
                    + getProperty(key) + ")");
        }
    }
    ...
    public Object getClassInstance(String key) throws IllegalArgumentException {
        ...
        if (s == null || "".equals(s.trim())) {
            throw new IllegalArgumentException("Property " + key + " must be a valid classname  : "
                    + key);
        }
        try {
    ...
    public static Properties restoreFromString(String str) {
        ...
        try {
            ...
            throw new IllegalStateException("restore properties from String occer error. str:"
                    + str, e);
        }
        return p;
    }
