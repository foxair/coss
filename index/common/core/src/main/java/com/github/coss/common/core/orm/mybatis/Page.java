...
import com.github.coss.common.core.helper.PageHelper;
...
public class Page<T> implements Serializable, Iterable<T> {
    ...
    public String toString() {
        return "[pageNumber=" + pageNumber + ", pageSize=" + pageSize + ", totalCount="
                + totalCount + "]";
    }

    public Page(QueryRequest<T> p, int totalCount) {
        this(p.getPageIndex(), p.getPageSize(), totalCount);
    }
    ...
    public Iterator<T> iterator() {
        return result == null ? (Iterator<T>) Collections.emptyList().iterator() : result
                .iterator();
    }
}
