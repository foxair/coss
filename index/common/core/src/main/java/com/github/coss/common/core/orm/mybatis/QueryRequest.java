...
import com.github.coss.common.core.orm.mybatis.query.Compare;
import com.github.coss.common.core.orm.mybatis.query.Condition;
import com.github.coss.common.core.orm.mybatis.query.Conditions;
import com.github.coss.common.core.orm.mybatis.query.Orders;
import com.github.coss.common.utils.lang.reflect.ReflectUtils;
...
public class QueryRequest<T> implements Serializable {
    ...
    public QueryRequest(Object filters, String sortColumns) {
        this(PAGE_DEFAULT_INDEX, PAGE_DEFAULT_SIZE, filters, sortColumns);
        try {
            setFieldMap((Map<String, String>) ReflectUtils.getProperty(filters.getClass(),
                    POJO_FIELD_MAP));
        } catch (Exception e) {
